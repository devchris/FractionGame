...
{
    [AddComponentMenu("Circular Gravity Force/CGF",0)]
    public class CircularGravity : MonoBehaviour
    {
        ...
        private IEnumerable<Rigidbody> AlignToForceFilter(ConstraintProperties _constraintProperties, IEnumerable<Rigidbody> list)
        {
        ...
        private void ApplyAlignment(IEnumerable<Rigidbody> list)
        {
            foreach (var item in list)
            {
                ...
                Quaternion targetRotation = Quaternion.FromToRotation(newLocal, up) * item.rotation;
        ...
        public static GameObject CreateCGF()
        {
            ...
            cgf.AddComponent<CircularGravity>()._drawGravityProperties.GravityLineMaterial = new Material(Shader.Find("UI/Default"));
